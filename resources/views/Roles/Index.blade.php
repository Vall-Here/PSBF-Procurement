                ...
                <ol class="inline-flex items-center space-x-1 rtl:space-x-reverse md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Daftar Role</span>
                        </div>
                    </li>
                </ol>
            </nav>
                        ...
                        <div
                            ...
                            <div class="flex items-center flex-1 space-x-4">
                                <h5>
                                    ...
                                    <span class="dark:text-white">{{ $totalRoles }}</span>
                                </h5>
                                        ...
                                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-4 py-2">
                                                @foreach ($role->permissions as $permission)
                                                    <span
                                                        class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 line-clamp-2 hover:line-clamp-none">{{ $permission->name }}</span>
                                                @endforeach
                                            </td>
                                            <td class="py-3 flex items-start justify-start ps-3">
                                                ...
                                                <form action="{{ route('roles.destroy', $role->id) }}" method="POST" class="ml-4">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="text-sm font-medium text-red-600 hover:underline"
                                                    onclick="return confirmDelete({{ $role->id }})">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
